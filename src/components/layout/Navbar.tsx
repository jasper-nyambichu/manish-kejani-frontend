        ...
        <div className="container mx-auto px-4 flex items-center gap-4 h-16">
          ...
          <form onSubmit={handleSearch} className="flex-1 hidden md:flex">
            <div className="relative w-full max-w-2xl">
              <input
                type="text"
                placeholder="Search kitchenware, bedding, décor..."
                value={searchQuery}
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/wishlist" className="relative hidden md:flex items-center text-foreground hover:text-primary transition-colors">
              ...
              <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-primary text-primary-foreground rounded-full text-[10px] flex items-center justify-center font-medium">0</span>
            </Link>
            <button
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-card border-b border-border">
          <div className="px-4 py-4 space-y-2">
            <Link to="/login" className="flex items-center gap-2 py-2 text-sm font-body font-medium text-foreground" onClick={() => setMobileMenuOpen(false)}>
              <User className="w-4 h-4" /> My Account
            </Link>
            <Link to="/wishlist" className="flex items-center gap-2 py-2 text-sm font-body font-medium text-foreground" onClick={() => setMobileMenuOpen(false)}>
